...
<div class="row mx-md-0 mx-2 ">
    <div class="col-12 blackColour transparentStandardWrapper">
        ...
        <div class="row lightGrayBackground">
            <div class="col-12 px-4 py-2 ">
                <div class="row font-weight-bold font-size-2x" align="left">
                    Show off
                </div>
                <div class="row">
                    <div class="col-3 standardWrapper d-flex justify-content-center align-items-center p-2">
