...
<div class="standardWrapper row mx-md-0 mx-2 mb-3 mt-md-0 mt-3 justify-content-center">
    ...
    <div class="col-10 borderAll grayBorder mb-3 rounded d-flex flex-row flex-wrap align-items-center justify-content-center profilePageMainAchieve">
    </div>
    <div class="col-10 borderAll grayBorder mb-3 rounded d-flex flex-row flex-wrap align-items-center justify-content-center profilePageSpeedAchieve">
    </div>
