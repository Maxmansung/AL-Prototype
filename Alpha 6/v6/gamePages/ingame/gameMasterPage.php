...
<div class="container-fluid pb-3 pageSize">
    <div class="row justify-content-center pt-2 pt-sm-5">
        <div class="col-sm-11 col-12">
            <?php include($_SERVER['DOCUMENT_ROOT']."/gamePages/ingame/gameHUDMain.php"); ?>
        </div>
    </div>
    <div class="row justify-content-center pt-sm-3 pt-1">
        <div class="col-sm-11 col-12 ">
            <div class="row justify-content-between">
                <div class="col-12 d-block d-md-none mb-1 mb-md-0">
                ...
                <div class="col-md-7 col-12 mb-1 mb-md-0 order-0 d-none d-sm-block showZoneView1">
                    <?php include($_SERVER['DOCUMENT_ROOT']."/gamePages/ingame/gameZoneView.php"); ?>
                </div>
                <div class="col-md-7 col-12 mb-1 mb-md-0 order-0 d-block d-sm-none showZoneView2">
                    <?php include($_SERVER['DOCUMENT_ROOT']."/gamePages/ingame/gameZoneViewMobile.php"); ?>
                </div>
                <div class="col-md-7 col-12 mb-1 mb-md-0 order-0 showAvatarView d-none">
                    <?php include($_SERVER['DOCUMENT_ROOT']."/gamePages/ingame/gameAvatarView.php"); ?>
                </div>
                <div class="col-md-7 col-12 mb-1 mb-md-0 order-0 showAvatarOther d-none">
                    <?php include($_SERVER['DOCUMENT_ROOT']."/gamePages/ingame/gameAvatarOther.php"); ?>
                </div>
                <div class="col-md-7 col-12 mb-1 mb-md-0 order-0 showShrineView d-none">
                    <?php include($_SERVER['DOCUMENT_ROOT']."/gamePages/ingame/gameShrineView.php"); ?>
                </div>
                <div class="col-md-7 col-12 mb-1 mb-md-0 order-0 showMapView d-none">
    ...
    <div class="row justify-content-center pt-md-5 pt-1">
        <div class="col-12 col-sm-11">
            <div class="row justify-content-around">
                <div class="col-3 roundedButton borderAll grayBorder infoButtonLog clickableTransparent" onclick="changeInfoView(0)">
                ...
                <div class="col-3 roundedButton borderAll grayBorder infoButtonBuild clickableTransparent" onclick="changeInfoView(1)">
                ...
                <div class="col-3 roundedButton borderAll grayBorder infoButtonParty clickableTransparent" onclick="changeInfoView(2)">
                ...
                <div class="col-3 roundedButton borderAll grayBorder infoButtonGods clickableTransparent" onclick="changeInfoView(3)">
