...
<?php
if ($site === 1){
    echo "<div class='container-fluid'><div class='row justify-content-center blackBackground'><div class='col-12 col-sm-8 p-3 redColour font-size-2' align='center'><div class='font-weight-bold font-size-2x'>WARNING</div>This is the test site, some features will be broken, not work or the game may entirely freeze up here.<br>Please try to use <a href='https://www.arctic-lands.com'>www.arctic-lands.com</a> if you want to play the game</div> </div></div>";
}
?>
