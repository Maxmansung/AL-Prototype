...
if (isset($_POST["type"])) {
    ...
    if (array_key_exists("ERROR",$response)){
        ...
        if ($profile->getNightfall() === 1 && $type !== 47 && $control!== 15){
            ...
            $data1 = preg_replace('#[^A-Za-z0-9 ?()]#i', '', $_POST['data1']);
            $data2 = preg_replace('#[^A-Za-z0-9 ?()]#i', '', $_POST['data2']);
            $data3 = preg_replace('#[^A-Za-z0-9 ?()]#i', '', $_POST['data3']);
            $data4 = preg_replace('#[^A-Za-z0-9 ?()]#i', '', $_POST['data4']);
            $data5 = preg_replace('#[^A-Za-z0-9 ?()]#i', '', $_POST['data5']);
            $data6 = preg_replace('#[^A-Za-z0-9 ?()]#i', '', $_POST['data6']);
            switch ($type) {
                case 0:
