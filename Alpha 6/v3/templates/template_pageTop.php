...
<nav class="navbar d-md-flex d-none justify-content-between py-0 px-2 align-items-center darkGrayBackground">
    ...
    <div class="d-flex flex-column align-items-end">
        <div class="d-flex justify-content-center align-items-center mr-3 clickable" data-toggle="collapse" data-target="#alertBarWrapper" aria-expanded="false" aria-controls="#alertBarWrapper" onclick="markAsViewed()">
            <span class="badge badge-pill badge-dark notificationsCounter"><i class="fas fa-spinner"></i></span><span class="sr-only"><?php echo $text->loginNavNotifications() ?></span><span class="orangeColour font-size-3"><?php echo $profile->getProfileName() ?> </span>
        </div>
...
<nav class="navbar navbar-expand-md navbar-light justify-content-between whiteBackground">
    ...
    <div class="d-flex flex-column d-md-none align-items-end">
        <div class="d-flex justify-content-center align-items-center mr-3 clickable" data-toggle="collapse" data-target="#alertBarWrapper" aria-expanded="false" aria-controls="#alertBarWrapper" onclick="markAsViewed()">
            <span class="badge badge-pill badge-dark notificationsCounter"><i class="fas fa-spinner"></i></span><span class="sr-only"><?php echo $text->loginNavNotifications() ?></span><span class="orangeColour font-size-2x font-weight-bold"><?php echo $profile->getProfileName() ?> </span>
        </div>
        <div class="funkyFont mx-2" >
    ...
    <div class="navbar-collapse collapse d-md-flex justify-content-md-end" id="navbarSupportedContent">
        ...
        <div class="customNavbarButton font-size-2x px-2 pb-1 mx-3" onclick="goToPage('score')"><?php echo $text->loginNavScore() ?></div>
        ...
        ?>
        <div class="customNavbarButton font-size-2x px-2 pb-1 mx-3" onclick="goToPage('help')"><?php echo $text->loginNavWiki() ?></div>
    </div>
</nav>
