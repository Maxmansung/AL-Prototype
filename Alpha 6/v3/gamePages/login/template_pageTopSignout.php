<nav class="navbar d-flex justify-content-between py-0 px-2 align-items-center darkGrayBackground">
    ...
    <div class="d-flex flex-row align-items-center">
        <div><button class="btn btn-link d-none d-sm-flex" onclick="clickSignin()"><?php echo $text->loginNavLogin();?></button></div>
        <div><button class="btn btn-primary btn-sm py-0 ml-sm-3 ml-0 d-flex flex-row align-items-center" onclick="clickRegister()"><i class="fas fa-lock pr-2 font-size-3"></i><span class="font-size-2"><?php echo $text->loginNavSignup();?></span></button></div>
