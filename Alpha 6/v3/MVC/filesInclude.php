...
include(PROJECT_ROOT."/MVC/controller/modTrackingController.php");
...
include(PROJECT_ROOT."/MVC/controller/profileAlertController.php");
...
include(PROJECT_ROOT."/MVC/controller/profileWarningController.php");
...
include(PROJECT_ROOT . "/MVC/view/profileSearchViewAdmin.php");
include(PROJECT_ROOT . "/MVC/view/leaderboardScores.php");