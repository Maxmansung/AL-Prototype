...
include_once(PROJECT_ROOT ."/MVC/baseController/buildingType.php");
...
include_once(PROJECT_ROOT."/MVC/controller/itemController.php");
...
include_once(PROJECT_ROOT."/MVC/controller/recipeController.php");
