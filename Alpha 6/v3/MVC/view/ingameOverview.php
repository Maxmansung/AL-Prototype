...
class ingameOverview
{
    ...
    {
        $this->itemBackpack = itemView::getAllItemsView($avatar->getMapID(),"backpack",$avatar->getAvatarID());
        $this->itemGround = itemView::getAllItemsView($avatar->getMapID(),"ground",$avatar->getZoneID());
    ...
    public function getAllRecipes($backpack,$zone){
        ...
        $result = recipeController::findRecipe($itemArray,$zone->getBuildings(),false);
        return $result;
    }
