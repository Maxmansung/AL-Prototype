...
<div class="row darkGrayBackground whiteColour justify-content-center justify-content-sm-between my-3 mx-2 p-2">
    <div class="col-11 col-sm-6 col-md-4 d-flex flex-column justify-content-center align-items-center blueColour lightGrayBackground"><img src="/images/gamePage/shrines/snow_shrine.png" class="tempShrineImage d-none d-sm-flex m-2"><div class="d-flex d-sm-none">IMAGE HERE</div></div>
...
<div class="row darkGrayBackground whiteColour justify-content-center justify-content-sm-between my-3 mx-2 p-2">
    <div class="col-11 col-sm-6 col-md-4 d-flex flex-column justify-content-center align-items-center order-1 order-sm-1 blueColour lightGrayBackground"><img src="/images/gamePage/shrines/ice_shrine.png" class="tempShrineImage d-none d-sm-flex m-2"><div class="d-flex d-sm-none">IMAGE HERE</div></div>
...
<div class="row darkGrayBackground whiteColour justify-content-center justify-content-sm-between my-3 mx-2 p-2">
    <div class="col-11 col-sm-6 col-md-4 d-flex flex-column justify-content-center align-items-center blueColour lightGrayBackground"><img src="/images/gamePage/shrines/death_shrine.png" class="tempShrineImage d-none d-sm-flex m-2"><div class="d-flex d-sm-none">IMAGE HERE</div></div>
    <div class="col-11 col-sm-6 col-md-8 p-3 d-flex flex-column">
