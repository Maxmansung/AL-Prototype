...
<div class="row justify-content-center">
    <div class="col-12 col-sm-11 standardWrapper mt-5">
        ...
        <div class="row my-3 justify-content-center">
            ...
            if ($profile->getAccountType()<8){
                echo '<div class="adminLink clickable col-11 p-3 my-2" onclick = "selectPage(this.id)" id = "testing" >
                <div class="row justify-content-between align-items-center px-3" >
                    <div class="col-9 d-flex flex-row flex-wrap align-items-center" ><div class="font-size-3 pr-3" > Finding Chances </div ><div class="font-size-2 darkGrayColour" > This is purely for testing the finding chances of zones for development reasons </div ></div >
                    <div class="font-size-4" ><i class="fas fa-vial"></i></div >
                </div >
            </div >';
            }
            ?>
