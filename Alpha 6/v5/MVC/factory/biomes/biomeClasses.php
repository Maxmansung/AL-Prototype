...
include_once(PROJECT_ROOT."/MVC/factory/biomes/biome7.php");
include_once(PROJECT_ROOT."/MVC/factory/biomes/biome8.php");
include_once(PROJECT_ROOT."/MVC/factory/biomes/biome9.php");
