...
if (isset($_POST["type"])) {
    ...
    $excludedRequests = array(226,225,213,204,198,197,196,183,49);
                ...
                switch ($type) {
                    ...
                    */
                    ...
                    case 43;
                        ...
                        $response = playerMapZoneController::worshipShrine($profile->getAvatar());
                        break;
                    case 44:
                    ...
                    case 52:
                        ...
                        break;
                    case 183:
                        //Used to update the players password
                        $response = profileController::updatePassword($data1,$data2,$data3);
                        //Returns ERROR or ALERT
                        break;
                    case 184:
