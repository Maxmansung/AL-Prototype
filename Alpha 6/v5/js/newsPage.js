...
function createNewsPage(data){
    ...
    for (var x in data){
        $("#newsListWrapper").prepend("<div class='col-11 row align-items-center justify-content-between rounded py-2 my-2 px-md-5 px-4 newsLinkWrapper' id='newsLink"+data[x].newsID+"' onclick='openNewsPage(this.id)'></div>");
