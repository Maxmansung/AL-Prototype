...
<article id="editProfilePage">
    ...
    <form method="post" id="avatarImageUpload">
        <div id="uploadTitle">Change Avatar</div>
        <div class="horizontalWrap" id="centerAlign">
            <div id="userCardImage">
                Avatar Image here
            </div>
            <div class="verticalWrap" id="uploadImagePadding">
                <input type="file" name="fileToUpload" id="fileToUpload" onchange="updateImagePreview()">
                <button type="submit" id="uploadButton">Upload</button>
            </div>
        </div>
            <div id="uploadInformation">
