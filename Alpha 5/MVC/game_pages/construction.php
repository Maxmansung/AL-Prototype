    ...
    <section class="horizontalWrap">
        ...
        <section class="verticalWrap" id="constructionUpgrades">
            <div id="researchOverview" class="titleText">
                ...
                <div class='imagediv' id="researchBuildingButton" onclick="researchButton()">
                    <img class='buttonImage' src='/images/researchIcon.png'>
                    <div class='imagetext'>
                        Perform Research
                        <br>
                        <div class='explanationText'>
                            This will progress you towards understanding a new building
                        </div>
                    </div>
                </div>
            </div>
            <div id="researchChoiceWrap">
                <div class="titleText">
                    Select a Discovery
                </div>
            </div>
            <div class="horizontalLine"></div>
            <div class="verticalWrap" id="locksWrapper">
                <div class="titleText">
                    Locks
                </div>
                <div id="lockArray">
