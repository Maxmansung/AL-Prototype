...
function textFormat(start,end,key){
    this.start = start;
    this.end = end;
    this.key = key;
}
...
var bold = new textFormat("<strong>","</strong>","**");
var italic = new textFormat("<i>","</i>","//");
var roleplay = new textFormat("<div class='roleplayTextFormat'>","</div>","^^");
var formatArray = [bold,italic,roleplay];


//THE FUNCTIONS USED TO FORMAT THE TEXT PAGE CAN BE FOUND HERE


function getTextFormatting(text){
    //This creates the correct new lines
