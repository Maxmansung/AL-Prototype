    ...
    hr.onreadystatechange = function () {
        if (hr.readyState == 4 && hr.status == 200) {
            ...
            if ("ERROR" in response){
                ...
                if(!alert("Your profile has been updated")){window.location = "https://www.arctic-lands.com/user.php?u="+response.Success;}
            }
...
function displayProfile(profile){
    ...
    $("#userCardScore").empty()
        .append("<span>Level: "+profile.profileLevel+"</span><span>Achievement Score: "+profile.profileScore+"</span>");
    $("#userCardImage").empty()
...
function editBio(){
    window.location ="https://www.arctic-lands.com/admin/editProfile.php";
}
...
function updateImagePreview(){
    ...
    if (files.length == 1) {
        ...
        if (formData.get(0) != null) {
            ...
            var url = window.URL.createObjectURL(formData.get(0));
            userCardImageFile.src = url;
        } else {
                ...
                hr.onreadystatechange = function () {
                    if (hr.readyState == 4 && hr.status == 200) {
                        ...
                        if ("ERROR" in response){
                            ...
                            window.location.href = "https://www.arctic-lands.com/user.php?u="+response.SUCCESS;
                        }
                    }
                };
                hr.send(formData);
