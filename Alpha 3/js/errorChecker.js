...
function errors(id){
    switch (id) {
        ...
        case 4:
            ...
            break;
        case 5:
            alert("Nothing was found after searching");
            ajax_GetHUD();
            break;
        case 6:
        ...
        case 37:
            if (!alert("This profile does not exist")) {
                window.location = "https://www.arctic-lands.com/";
            }
            break;
        case 38:
        ...
        case 53:
            if (!alert("Congratulations, you're now an active player and can join the larger test maps")) {
                window.location.href="https://www.arctic-lands.com";
            }
            break;
        case 54:
...
function alerts(response,data){
    ...
    switch (response){
        case 1:
            var text = getArrayWriting(data);
            if(!alert("You have created a "+text)){window.location.reload();}
            break;
        case 2:
            getRecipeList(data);
            break;
