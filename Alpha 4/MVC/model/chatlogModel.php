...
class chatlogModel extends chatlog
{
    ...
    public static function insertChatLogZone($chatController, $type){
        ...
        if ($type == "Insert") {
            $req = $db->prepare("INSERT INTO ".$chatlogType." (chatID, mapID, zoneID, avatarID, mapDay, messageTime, messageText) VALUES (:chatID, :mapID, :zoneID, :avatarID, :mapDay, :messageTime, :messageText)");
        } elseif ($type == "Update") {
    ...
    public static function insertChatLogGroup($chatController, $type){
        ...
        $db = db_conx::getInstance();
        if ($type == "Insert") {
            $req = $db->prepare("INSERT INTO ".$chatlogType." (chatID, mapID, groupID, avatarID, mapDay, messageTime, messageText) VALUES (:chatID, :mapID, :groupID, :avatarID, :mapDay, :messageTime, :messageText)");
        } elseif ($type == "Update") {
    ...
    public static function insertChatLogBuilding($chatController, $type){
        ...
        $db = db_conx::getInstance();
        if ($type == "Insert") {
            $req = $db->prepare("INSERT INTO ".$chatlogType." (chatID, mapID, zoneID, buildingID, mapDay, messageTime, messageText) VALUES (:chatID, :mapID, :zoneID, :buildingID, :mapDay, :messageTime, :messageText)");
        } elseif ($type == "Update") {
    ...
    public static function insertChatlogOther($chatController, $type){
        ...
        $db = db_conx::getInstance();
        if ($type == "Insert") {
            $req = $db->prepare("INSERT INTO ".$chatlogType." (chatID, mapID, zoneID, otherVar, mapDay, messageTime, messageText) VALUES (:chatID, :mapID, :zoneID, :otherVar, :mapDay, :messageTime, :messageText)");
        } elseif ($type == "Update") {
