...
class buildingModel extends building
{
        ...
        private function __construct($buildingModel)
    {
        if (isset($buildingModel['buildingID'])) {
            ...
            $tempVar = buildingModel::getBuildingTypeDetails(intval($buildingModel['buildingType']));
