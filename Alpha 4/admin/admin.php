...
<div id="adminpage">
    ...
    <form id="createmap" action="../MVC/ajax_php/mapcreate_ajax.php" method="post">
        ...
        <div class="admininput">
            Day length
            <input type="number" id="daylength" name="length" step="0.1" onfocus="emptyElement('status')" min="0.1" max="100" value="8">
        </div>
        <div class="admininput">
            Base Night Temp
        ...
        <div class="admininput">
            ...
            <select id="gameType" name="gameType">
                <?php
                include_once($_SERVER['DOCUMENT_ROOT'] . "/MVC/model/gameTypeModel.php");
                $array = gameTypeModel::getTypes();
                foreach ($array as $type){
                    echo "<option value='".$type->getType()."'>".$type->getType()."</option>";
                }
                ?>
            </select>
        </div>
